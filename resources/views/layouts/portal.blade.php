...
<head>
    ...
    <title>@yield('title', '360Cars | Panel')</title>
    <meta name="description" content="Panel de gestión de 360Cars para compradores, vendedores y administración.">
            ...
            <div class="portal-sidebar__content">
                <nav class="portal-nav">
                    @if(auth()->user()->hasRole('admin'))
                        ...
                        <p class="muted-label" style="padding: 0 1rem; margin-top: 1.5rem; margin-bottom: 0.5rem;">Configuración</p>
                        ...
                        <a href="{{ route('admin.features') }}" class="{{ request()->routeIs('admin.features') ? 'is-active' : '' }}">
                    ...
                    @elseif(auth()->user()->hasRole('seller', 'dealer'))
                        <p class="muted-label" style="padding: 0 1rem; margin-bottom: 0.5rem;">Mi Negocio</p>
                    ...
                    @else
                        <p class="muted-label" style="padding: 0 1rem; margin-bottom: 0.5rem;">Mercado</p>
            ...
            <header class="portal-header">
                ...
                <div class="portal-header__actions">
                    ...
                    <div class="header-icons">
                        <button class="icon-btn"><span class="icon-placeholder">🔔</span></button>
                        <button class="icon-btn"><span class="icon-placeholder">⚙️</span></button>
                    </div>
                </div>
            </header>
