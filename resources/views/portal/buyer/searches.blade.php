...
@section('title', 'Busquedas buyer | Movikaa')
@section('portal-eyebrow', 'Buyer busquedas')
@section('portal-title', 'Busquedas guardadas')
@section('portal-copy', 'Tus alertas y filtros guardados en una sola pantalla, con acceso mas ordenado y paginado.')
...
<nav class="portal-nav">
    ...
    <a href="{{ route('buyer.searches.index') }}" class="is-active">Busquedas</a>
...
<section class="dashboard-panel">
    <div class="panel-heading"><div><p class="portal-kicker">Alertas</p><h2>Busquedas guardadas</h2></div><span class="status-badge">{{ $savedSearchList->total() }} filtros</span></div>
    <div class="catalog-stack">
        ...
        @empty
            <div class="empty-state"><strong>Sin alertas activas.</strong><p>Desde el inventario puedes guardar filtros para volver rapido.</p></div>
        @endforelse
    </div>
