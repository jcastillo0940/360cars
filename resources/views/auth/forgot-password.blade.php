...
<div class="w-full max-w-[480px]">
    ...
    <div class="rounded-[2.5rem] border border-white/10 bg-[#0b0b0f]/80 p-8 shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:p-10">
        ...
        <div class="text-center">
            <h1 class="font-headline text-3xl font-extrabold tracking-tight text-white sm:text-4xl">¿Olvidaste tu clave?</h1>
            <p class="mt-3 text-sm leading-relaxed text-slate-400">No te preocupes. Dinos tu correo y te enviaremos un enlace seguro para restablecerla.</p>
        </div>
