...
class SellerOnboardingStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'photo_front' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_rear' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_left' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_right' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_driver_interior' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_passenger_interior' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_dashboard' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_back_seats' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_engine' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_trunk' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_wheels' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_extra_1' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
            'photo_extra_2' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240', 'clamav'],
