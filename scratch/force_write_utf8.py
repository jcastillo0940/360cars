...
content = """@extends('layouts.marketing')
...
@endphp
<div class="vendedor-onboarding-page theme-dark bg-black text-white min-h-screen font-body">
    <nav class="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-black/90 backdrop-blur-md" data-topbar>
        <div class="mx-auto flex h-20 max-w-screen-2xl items-center justify-between px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 lg:gap-12">
                ...
                <div class="hidden items-center gap-8 md:flex">
                    ...
                    <a href="{{ route('valuation.index') }}" class="font-headline text-sm font-bold tracking-tight text-slate-200 transition hover:text-primary">Estimación de mercado</a>
                    ...
                    <details class="relative">
                        ...
                        <div class="absolute right-0 top-[calc(100%+0.75rem)] w-72 overflow-hidden rounded-3xl border border-white/10 bg-[#11131a] p-3 shadow-2xl">
                            <div class="rounded-2xl bg-white/5 p-4">
                                ...
                                <p class="mt-2 text-sm text-slate-400">Tu sesión ya está activa. Entra a tu panel o continúa publicando autos.</p>
                            </div>
        ...
        <div class="border-t border-white/10 bg-black px-4 py-4 shadow-xl md:hidden" data-mobile-menu hidden>
            <div class="flex flex-col gap-4">
                ...
                <a href="{{ route('valuation.index') }}" class="font-headline text-base font-bold tracking-tight text-slate-100">Estimación de mercado</a>
        ...
        <section class="relative overflow-hidden bg-black py-16 sm:py-20">
            <div class="absolute inset-0 hidden lg:block" aria-hidden="true">
                <div class="absolute inset-y-0 right-0 w-[56%] overflow-hidden">
                    <img class="h-full w-full scale-[1.06] object-cover object-right opacity-30 blur-[1px]" src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1600&q=80" alt="Vehículo listo para vender" />
                </div>
                ...
                <div class="grid gap-6 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
                    <aside class="grid gap-5 rounded-[28px] border border-white/10 bg-[#0d1117] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur sm:p-8 lg:sticky lg:top-28">
                        <div>
                            ...
                            <h1 class="mt-5 font-headline text-4xl font-extrabold tracking-tight text-white sm:text-5xl">Publica rápido y termina sin perderte.</h1>
                        ...
                        <div class="grid gap-4 rounded-2xl border border-white/10 bg-white/5 p-5">
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-2 text-sm leading-7 text-slate-400" data-progress-copy>Completa los datos base del auto para arrancar bien tu publicación.</p>
                                </div>
                                <div class="seller-progress-ring">
                                    <span data-progress-percent>20%</span>
                                </div>
                            </div>
                            <div class="vendedor-progress-bar">
                            ...
                            <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm">
                                ...
                                <p class="mt-2 text-sm leading-7 text-slate-400">Tu avance se guarda en este navegador para que no pierdas información mientras avanzas.</p>
                            </div>
                            <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm">
                                <span class="text-xs font-bold uppercase tracking-[0.2em] text-primary">Paso actual</span>
                                <div class="mt-3 grid gap-2">
                                    <strong class="text-base font-bold text-white" data-current-step-title>Identidad del vehículo</strong>
                        ...
                        <div class="grid gap-3 rounded-2xl bg-primary px-5 py-5 text-white">
                            <span class="text-xs font-bold uppercase tracking-[0.2em] text-white/65">Consejo del paso</span>
                            <p class="text-sm leading-7 text-white/90" data-sidebar-tip>Usa el nombre comercial correcto de la versión y una descripción breve pero confiable.</p>
                        </div>
                        ...
                        <div class="grid gap-3 rounded-2xl border border-white/10 bg-[#12131a] px-5 py-5">
                            ...
                            <p class="text-sm leading-7 text-slate-400" data-sidebar-loader>Avanza paso a paso. Aquí verás el estado de carga, compresión o validación.</p>
                        </div>
                    </aside>
                    ...
                    <section class="rounded-[28px] border border-white/10 bg-[#0d1117] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-7 lg:min-h-[calc(100vh-8.5rem)]">
                        ...
                        <div class="mb-5 flex flex-col gap-4 border-b border-white/10 pb-5 sm:flex-row sm:items-end sm:justify-between">
                            <div>
                                <span class="text-xs font-bold uppercase tracking-[0.2em] text-secondary">Publicación guiada</span>
                                <h2 class="mt-2 font-headline text-3xl font-extrabold tracking-tight text-white">Completa la publicación de tu auto</h2>
                                <p class="mt-2 max-w-2xl text-sm leading-7 text-slate-400">Diseñado para que cualquier persona publique rápido, con buena información y sin registrarse al inicio.</p>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('seller.onboarding.store') }}" class="seller-onboarding" enctype="multipart/form-data" data-wizard data-autosave-key="seller-onboarding-draft" data-usd-to-crc="{{ (float) data_get($exchangeQuote, 'usd_to_crc', 0) }}">
                            ...
                            <div class="grid gap-5">
                                <section class="wizard-step rounded-[24px] border border-white/10 bg-white/5 p-5 sm:p-6" data-step-panel data-step-title="Identidad del vehículo">
                                    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                            ...
                                            <p class="mt-2 text-sm leading-7 text-slate-400">Define correctamente el vehículo para mejorar su relevancia en búsquedas y comparaciones.</p>
                                        </div>
                                    ...
                                    <div class="mb-5 grid gap-4 md:grid-cols-2">
                                        <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm"><span class="text-xs font-bold uppercase tracking-[0.2em] text-primary">Importante</span><p class="mt-2 text-sm leading-7 text-slate-400">La selección de modelo se filtra automáticamente según la marca para mantener consistencia.</p></div>
                                        <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm"><span class="text-xs font-bold uppercase tracking-[0.2em] text-primary">Consejo</span><p class="mt-2 text-sm leading-7 text-slate-400">Una buena descripción acelera los contactos porque responde dudas antes del chat o la llamada.</p></div>
                                    </div>
                                ...
                                <section class="wizard-step rounded-[24px] border border-white/10 bg-white/5 p-5 sm:p-6" data-step-panel data-step-title="Especificaciones y precio" hidden>
                                    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                            ...
                                            <p class="mt-2 text-sm leading-7 text-slate-400">Normalizamos la información clave para que el anuncio sea claro, comparable y confiable.</p>
                                        </div>
                                    ...
                                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                                        ...
                                        <label class="grid gap-2 md:col-span-2 xl:col-span-3"><span class="text-sm font-semibold text-slate-100">Precio en colones (CRC)</span><input class="rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm font-semibold text-white shadow-sm" type="number" step="1" name="price" value="{{ old('price', data_get($prefill, 'price')) }}" required data-price-input placeholder="18500000" /><small class="text-sm text-slate-400" data-price-preview>El precio oficial se mostrará en colones. Debajo verás una referencia pequeña en dólares.</small></label>
                                    </div>
                                ...
                                <section class="wizard-step rounded-[24px] border border-white/10 bg-white/5 p-5 sm:p-6" data-step-panel data-step-title="Extras y fotos" hidden>
                                    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                            ...
                                            <h3 class="mt-2 font-headline text-2xl font-extrabold tracking-tight text-white">Extras y fotografías</h3>
                                    ...
                                    <div class="mb-5 grid gap-4 lg:grid-cols-3">
                                        ...
                                        <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm"><strong class="block text-sm font-bold text-white">Recomendadas</strong><p class="mt-2 text-sm leading-7 text-slate-400">Tablero, motor, baúl, asientos traseros y aros.</p></div>
                                    ...
                                    <div class="rounded-[24px] border border-white/10 bg-[#12131a] p-5 shadow-sm">
                                        ...
                                        <div class="feature-option-list">
                                            ...
                                            @empty
                                                <p class="text-sm text-slate-400">Todavía no hay características configuradas. Puedes agregarlas desde el administración.</p>
                                            @endforelse
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-5 rounded-[24px] border border-white/10 bg-[#12131a] p-5 shadow-sm" data-photo-sequence>
                                        ...
                                        <div class="grid gap-4">
                                            <div class="photo-sequence-panel" data-photo-panel data-photo-required="true" data-photo-title="Fotografía frontal">
                                                <label class="vendedor-photo-card grid gap-3 rounded-2xl border border-white/10 bg-white/5 p-4">
                                                    <span class="text-sm font-semibold text-slate-100">Fotografía frontal</span>
                                            ...
                                            <div class="photo-sequence-panel" data-photo-panel data-photo-required="true" data-photo-title="Fotografía trasera" hidden>
                                                <label class="vendedor-photo-card grid gap-3 rounded-2xl border border-white/10 bg-white/5 p-4">
                                                    <span class="text-sm font-semibold text-slate-100">Fotografía trasera</span>
                                            ...
                                            <div class="photo-sequence-panel" data-photo-panel data-photo-required="true" data-photo-title="Lateral izquierda" hidden>
                                                <label class="vendedor-photo-card grid gap-3 rounded-2xl border border-white/10 bg-white/5 p-4">
                                                    ...
                                                    <small class="text-sm text-slate-400" data-file-hint>Obligatoria. Toma el costado completo del vehículo.</small>
                                                </label>
                                            </div>
                                            ...
                                            <div class="rounded-2xl border border-white/10 bg-white/5 p-4" data-photo-optional-entry hidden>
                                                ...
                                                <h5 class="mt-2 text-lg font-bold text-white">Puedes subir más fotografías</h5>
                                                ...
                                                <div class="mt-4 flex flex-col gap-3 sm:flex-row">
                                                    <button type="button" class="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-bold text-white transition hover:bg-primary-container" data-photo-optional-open>Sí, subir más fotos</button>
                                            ...
                                            <div class="photo-sequence-panel" data-photo-panel data-photo-optional="true" data-photo-title="Foto adicional 2" hidden>
                                                <label class="vendedor-photo-card grid gap-3 rounded-2xl border border-white/10 bg-white/5 p-4">
                                                    ...
                                                    <small class="text-sm text-slate-400" data-file-hint>Opcional. Puedes dejarla vacía si ya terminaste.</small>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                        <button type="button" class="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-[#12131a] px-5 py-3 text-sm font-bold text-white transition hover:border-primary hover:bg-white/5 hover:text-white" data-wizard-prev>Volver</button>
                                        <button type="button" class="inline-flex items-center justify-center gap-2 rounded-xl bg-secondary px-5 py-3 text-sm font-bold text-white transition hover:bg-secondary-container" data-wizard-next>Siguiente: ubicación</button>
                                    </div>
                                </section>

                                <section class="wizard-step rounded-[24px] border border-white/10 bg-white/5 p-5 sm:p-6" data-step-panel data-step-title="Ubicación en Costa Rica" hidden>
                                    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                    ...
                                    <div class="mb-5 grid gap-4 md:grid-cols-2">
                                        <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm"><strong class="block text-sm font-bold text-white">País permitido</strong><p class="mt-2 text-sm leading-7 text-slate-400">Solo aceptamos ubicaciones dentro de Costa Rica.</p></div>
                                        <div class="rounded-2xl bg-[#12131a] p-4 shadow-sm"><strong class="block text-sm font-bold text-white">Sugerencia</strong><p class="mt-2 text-sm leading-7 text-slate-400">Busca por distrito, cantón o punto conocido para que el comprador entienda mejor la zona.</p></div>
                                    </div>

                                    <div class="grid gap-4 md:grid-cols-2">
                                        <label class="grid gap-2 md:col-span-2"><span class="text-sm font-semibold text-slate-100">Dirección o punto de referencia</span><input class="rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm font-semibold text-white shadow-sm" type="text" name="map_search" value="{{ old('location_label') }}" placeholder="Ej. Barrio Los Yoses, cerca del parque, San Pedro" data-map-search required /></label>
                                        ...
                                        @else
                                            <div class="grid gap-2 md:col-span-2">
                                                ...
                                                <div class="map-canvas rounded-[24px] border border-white/10 bg-[#12131a] flex items-center justify-center p-8 text-center">
                                                    <div class="map-canvas__fallback text-slate-400">Configura GOOGLE_MAPS_API_KEY para usar el mapa interactivo. Mientras tanto puedes completar manualmente provincia, cantón, distrito y la referencia del auto.</div>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                @unless ($currentUser)
                                <section class="wizard-step rounded-[24px] border border-white/10 bg-white/5 p-5 sm:p-6" data-step-panel data-step-title="Cuenta vendedor" hidden>
                                    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                            <span class="text-xs font-bold uppercase tracking-[0.2em] text-secondary">Paso 5</span>
                                            <h3 class="mt-2 font-headline text-2xl font-extrabold tracking-tight text-white">Crea tu cuenta vendedor al final</h3>
                                            <p class="mt-2 text-sm leading-7 text-slate-400">Aquí terminamos. Se crea tu cuenta y tu auto queda listo para administrarse desde tu panel de vendedor.</p>
                                        </div>
                                        <span class="inline-flex rounded-full bg-white/5 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-slate-300">Cierre rápido</span>
                                    </div>

                                    <div class="grid gap-4 md:grid-cols-2">
                                        <label class="grid gap-2"><span class="text-sm font-semibold text-slate-100">Nombre completo</span><input class="rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm font-semibold text-white shadow-sm" type="text" name="vendedor_name" value="{{ old('vendedor_name') }}" required /></label>
                                        <label class="grid gap-2"><span class="text-sm font-semibold text-slate-100">Correo electrónico</span><input class="rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm font-semibold text-white shadow-sm" type="email" name="contact_email" value="{{ old('contact_email') }}" placeholder="Opcional si usas teléfono" /></label>
                                                                                <label class="grid gap-2"><span class="text-sm font-semibold text-slate-100">Contraseña</span><input class="rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm font-semibold text-white shadow-sm" type="password" name="password" required /></label>
                                        <label class="grid gap-2 md:col-span-2"><span class="text-sm font-semibold text-slate-100">Confirmar contraseña</span><input class="rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm font-semibold text-white shadow-sm" type="password" name="password_confirmation" required /></label>
                                        <label class="inline-flex items-center gap-3 rounded-2xl border border-white/10 bg-[#12131a] px-4 py-4 text-sm text-slate-100 md:col-span-2"><input type="checkbox" name="accept_terms" value="1" required class="h-4 w-4 accent-[var(--color-secondary)] bg-[#12131a]" /> <span>Acepto términos y confirmo que el auto está en Costa Rica.</span></label>
                                    </div>

                                    <div class="mt-6 rounded-2xl bg-primary px-5 py-5 text-white">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                            <div>
                                                <span class="text-xs font-bold uppercase tracking-[0.2em] text-white/65">Resultado</span>
                                                <p class="mt-2 text-sm leading-7 text-white/90">Se crea tu cuenta de vendedor, se publica tu auto con plan básico y luego podrás publicar uno o varios autos desde tu panel.</p>
                                            </div>
                                            <button type="submit" class="inline-flex items-center justify-center gap-2 rounded-xl bg-secondary px-5 py-3 text-sm font-bold text-white transition hover:bg-secondary-container" data-submit-onboarding>Registrar auto y crear cuenta</button>
                                        </div>
                                    </div>
